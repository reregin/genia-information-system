...
Route::get('/lomba', function () { return view('lomba'); })->name('lomba');
Route::get('/details_lomba', function () { return view('details_lomba'); })->name('details_lomba');
Route::get('/details_blog', function () { return view('details_blog'); })->name('details_blog');
