                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="competition" name="competition" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <option value="PKM" {{ old('competition') == 'PKM' ? 'selected' : '' }}>PKM</option>
                            <option value="GELATIK" {{ old('competition') == 'GELATIK' ? 'selected' : '' }}>GELATIK</option>
                            <option value="ON MIPA PT" {{ old('competition') == 'ON MIPA PT' ? 'selected' : '' }}>ON MIPA PT</option>
                            <option value="COMPFEST" {{ old('competition') == 'COMPFEST' ? 'selected' : '' }}>COMPFEST</option>
                        </select>
                        @error('competition')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
